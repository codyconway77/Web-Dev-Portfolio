        ...
        <div id="projects" className={styles["projects-container"]}>
          <div className={styles['project-card']}>
            ...
            <a href='https://eager-euclid-acf984.netlify.app/' target={'_blank'} rel='noreferrer'>
              <Image src={CalculatorPreview} alt="preview picture of a calculator website" className={styles['project-pic']} />
            </a>  
          </div>
          <div className={styles['project-card']}>
            <h3>Pomodoro Clock</h3>
            <a href="https://react-fcc-pomodoro-clock.netlify.app/" target={'_blank'} rel='noreferrer'>
              <Image src={PomodoroPreview} alt='preview picture of a pomodoro clock website' className={styles['project-pic']} />
            </a>
          </div>
          <div className={styles['project-card']}>
            <h3>Randome Quote Machine</h3>
            <a href="https://quirky-random-quote-generator.netlify.app/" target={'_blank'} rel='noreferrer'>
              <Image src={QuotePreview} alt='preview picture of a random quote website' className={styles['project-pic']} />
            </a>
          </div>
          <div className={styles['project-card']}>
            <h3>Text to Markdown</h3>
            <a href="https://quirky-fcc-markdown-previewer.netlify.app/" target={'_blank'} rel='noreferrer'>
              <Image src={MarkdownPreview} alt='preview picutre of a text to markdown website' className={styles['project-pic']} />
            </a>
          </div>
        </div>
        <h2>Contact Me</h2>
